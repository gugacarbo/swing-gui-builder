 ![Version Badge](https://img.shields.io/badge/dynamic/json.png?url=https%3A%2F%2Fraw.githubusercontent.com%2Fgugacarbo%2Fswing-gui-builder%2Frefs%2Fheads%2Fmain%2Fpackage.json&query=%24.version&suffix=-beta&style=flat&label=version&cacheSeconds=3600) ![GitHub License](https://img.shields.io/github/license/gugacarbo/swing-gui-builder.png) ![Visual Studio Marketplace Last Updated](https://img.shields.io/visual-studio-marketplace/last-updated/gugacarbo.swing-gui-builder.png)

[![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/gugacarbo/swing-gui-builder/test.yml.png?branch=main&label=Tests)](https://gugacarbo.github.io/swing-gui-builder/) [![Coverage Total](./media/coverage-badges/total.png)](https://gugacarbo.github.io/swing-gui-builder/) [![Tests Ext](./media/coverage-badges/extension.png)](https://gugacarbo.github.io/swing-gui-builder/) [![Tests Webview](./media/coverage-badges/webview.png)](https://gugacarbo.github.io/swing-gui-builder/)
